...
| `Data` | [`List<RestrictionSearchCardResponseDataItems>`](../../doc/models/restriction-search-card-response-data-items.md) | Optional | - | List<RestrictionSearchCardResponseDataItems> getData() | setData(List<RestrictionSearchCardResponseDataItems> data) |
