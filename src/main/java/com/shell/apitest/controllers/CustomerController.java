...
import com.shell.apitest.models.CreateCardGroupRequest;
...
import com.shell.apitest.models.UpdateCardGroupRequest;
import com.shell.apitest.models.UpdateCardGroupResponse;
...
public final class CustomerController extends BaseController {
    ...
    /**
     * This API allows creating a new Card Group in the Shell Cards Platform. It will also allow
     * moving of cards (up to 500 cards) into the newly created card-group. ### Move Card requests
     * are queued after passing the below validations * Given PAN matches with only one card. * Card
     * is allowed to be moved to the Target Card Group and/or * Target account requested. * There is
     * no pending Move Card request for the same card in the queue which is submitted on the same
     * date and is yet to be processed or has been processed successfully.
     * @param  apikey  Required parameter: This is the API key of the specific environment which
     *         needs to be passed by the client.
     * @param  requestId  Required parameter: Mandatory UUID (according to RFC 4122 standards) for
     *         requests and responses. This will be played back in the response from the request.
    ...
    private ApiCall<CreateCardGroupResponse, ApiException> prepareCreateCardGroupRequest(
        ...
        return new ApiCall.Builder<CreateCardGroupResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(
                                response -> ApiHelper.deserialize(response, CreateCardGroupResponse.class))
                        .nullify404(false)
                        .localErrorCase("400",
                                 ErrorCase.setReason("The server cannot or will not process the request  due to something that is perceived to be a client\r\n error (e.g., malformed request syntax, invalid \r\n request message framing, or deceptive request routing).",
                                (reason, context) -> new DefaultErrorException(reason, context)))
    ...
    /**
     * This API allows updating or removing a Card Group in the Shell Cards Platform. It also allows
     * moving of cards out of a card group or from one card group to another existing card group.
     * The request for updating or removing of the card group, creationg of a new card group
     * (where-applicable) and moving of card into another card group will be queued at Microservices
     * after passing the basic validations.
     * @param  apikey  Required parameter: This is the API key of the specific environment which
     *         needs to be passed by the client.
     * @param  requestId  Required parameter: Mandatory UUID (according to RFC 4122 standards) for
     *         requests and responses. This will be played back in the response from the request.
    ...
    private ApiCall<UpdateCardGroupResponse, ApiException> prepareUpdateCardGroupRequest(
        ...
        return new ApiCall.Builder<UpdateCardGroupResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        .deserializer(
                                response -> ApiHelper.deserialize(response, UpdateCardGroupResponse.class))
                        .nullify404(false)
                        .localErrorCase("400",
                                 ErrorCase.setReason("The server cannot or will not process the request  due to something that is perceived to be a client\r\n error (e.g., malformed request syntax, invalid \r\n request message framing, or deceptive request routing).",
                                (reason, context) -> new DefaultErrorException(reason, context)))
