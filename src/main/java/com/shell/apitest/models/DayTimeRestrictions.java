...
public class DayTimeRestrictions {
    ...
    public String toString() {
        return "DayTimeRestrictions [" + "monday=" + monday + ", tuesday=" + tuesday
                + ", wednesday=" + wednesday + ", thursday=" + thursday + ", friday=" + friday
                + ", saturday=" + saturday + ", sunday=" + sunday + ", timeFrom=" + timeFrom
                + ", timeTo=" + timeTo + "]";
    }
    ...
    public static class Builder {
        ...
        public DayTimeRestrictions build() {
            return new DayTimeRestrictions(monday, tuesday, wednesday, thursday, friday, saturday,
