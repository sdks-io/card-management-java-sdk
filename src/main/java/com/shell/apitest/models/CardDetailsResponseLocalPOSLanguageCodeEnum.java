...
/**
 * CardDetailsResponseLocalPOSLanguageCodeEnum to be used.
 */
public enum CardDetailsResponseLocalPOSLanguageCodeEnum {
     ...
     */
    @JsonCreator
    public static CardDetailsResponseLocalPOSLanguageCodeEnum constructFromString(String toConvert) throws IOException {
        CardDetailsResponseLocalPOSLanguageCodeEnum enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static CardDetailsResponseLocalPOSLanguageCodeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of CardDetailsResponseLocalPOSLanguageCodeEnum values to list of string values.
     * @param toConvert The list of CardDetailsResponseLocalPOSLanguageCodeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<CardDetailsResponseLocalPOSLanguageCodeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (CardDetailsResponseLocalPOSLanguageCodeEnum enumValue : toConvert) {
